...
$THEME->scss = function($theme) {                                                                                                   
    return theme_etcobase_get_main_scss_content($theme);                                                                               
};

// This is a function that returns some SCSS as a string to prepend to the main SCSS file.                                          
$THEME->prescsscallback = 'theme_etcobase_get_pre_scss';

$THEME->extrascsscallback = 'theme_etcobase_get_extra_scss';